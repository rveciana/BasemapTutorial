...
#. The map is created using the Basemap class, which has many options. In this example, we use the `Ortographic projection <http://en.wikipedia.org/wiki/Orthographic_projection_in_cartography>`_ centered at longitude 0 and latitude 0.
